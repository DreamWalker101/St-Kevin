...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .section-preview-ph-icon { width: 40px; height: 40px; background: rgba(5,30,66,0.08); border-radius: 10px; display: flex; align-items: center; justify-content: center; margin-bottom: 4px; }
    .section-preview-ph-title { font-family: 'Montserrat', sans-serif; font-size: 14px; font-weight: 700; color: #051E42; }
    .section-preview-ph-hint { font-size: 12px; color: rgba(5,30,66,0.45); line-height: 1.7; max-width: 260px; }
    .section-preview-ph-hint code { background: #E2E6EA; border-radius: 4px; padding: 1px 6px; font-family: monospace; font-size: 11px; color: #051E42; }
    .preview-panel-footer { padding: 8px 16px; font-size: 11px; color: rgba(5,30,66,0.4); border-top: 1px solid #E2E6EA; text-align: center; }

    /* ── Section nav ── */
    .section-nav { display: flex; gap: 6px; overflow-x: auto; padding-bottom: 4px; margin-bottom: 16px; scrollbar-width: none; }
    .section-nav::-webkit-scrollbar { display: none; }
    .section-nav-btn { flex-shrink: 0; padding: 6px 14px; border-radius: 999px; font-size: 12px; font-family: 'Inter', sans-serif; font-weight: 500; color: rgba(5,30,66,0.5); cursor: pointer; border: none; background: transparent; transition: background 0.15s, color 0.15s; white-space: nowrap; }
    .section-nav-btn.active { background: #051E42; color: #ffffff; }
    .section-nav-btn:hover:not(.active) { background: #F0EDE5; color: #051E42; }
    ...
    .img-picker-btn:hover { background: #0A2D5C; }
    .img-picker-clear {
      background: transparent;
      border: 1.5px solid #E2E6EA;
      border-radius: 8px;
    ...
    .media-modal-box {
      ...
      display: flex;
      flex-direction: column;
      box-shadow: 0 20px 60px rgba(5,30,66,0.25);
      overflow: hidden;
    }
    .media-modal-header {
    ...
    .media-modal-upload-btn:hover { background: #6B1A26; }
    .media-modal-grid {
      flex: 1;
      overflow-y: auto;
      padding: 16px 24px;
    ...
    .media-thumb:hover { border-color: #051E42; }
    .media-thumb.selected { border-color: #8A2232; }
    .media-thumb img {
...
<body class="min-h-screen">
  ...
  <div style="max-width:1800px;margin:0 auto;padding:32px 48px 64px;">
    ...
    <div id="tab-homepage" class="tab-panel">
      <div class="page-editor-split">
        <div class="page-editor-left">
          <nav class="section-nav">
            <button class="section-nav-btn active" onclick="showSection('homepage','hero','sk-section-hero',this)">Hero</button>
            <button class="section-nav-btn" onclick="showSection('homepage','quotes','sk-section-quotes',this)">Quotes Carousel</button>
            <button class="section-nav-btn" onclick="showSection('homepage','welcome','sk-section-welcome',this)">Welcome Block</button>
            <button class="section-nav-btn" onclick="showSection('homepage','pillars','sk-section-pillars',this)">Pillars</button>
            <button class="section-nav-btn" onclick="showSection('homepage','effect','sk-section-effect',this)">Effect Section</button>
            <button class="section-nav-btn" onclick="showSection('homepage','testimonials','sk-section-testimonials',this)">Testimonials</button>
            <button class="section-nav-btn" onclick="showSection('homepage','videos','sk-section-videos',this)">Video Grid</button>
            <button class="section-nav-btn" onclick="showSection('homepage','cta','sk-section-enrol-cta',this)">Enrolments CTA</button>
          </nav>
      ...
      <!-- The St Kevin's Effect -->
      <div class="section-card">
        <div class="section-title">The St Kevin's Effect</div>
          ...
          <div class="preview-panel">
            ...
            <div class="section-preview-wrap">
              ...
              <div id="preview-ph-homepage" class="section-preview-ph">
                <div class="section-preview-ph-icon"><svg width="20" height="20" viewBox="0 0 20 20" fill="none"><rect x="2" y="2" width="7" height="7" rx="1.5" fill="#051E42" opacity=".25"/><rect x="11" y="2" width="7" height="7" rx="1.5" fill="#051E42" opacity=".25"/><rect x="2" y="11" width="7" height="7" rx="1.5" fill="#051E42" opacity=".25"/><rect x="11" y="11" width="7" height="7" rx="1.5" fill="#051E42" opacity=".25"/></svg></div>
    ...
    <div id="tab-about" class="tab-panel">
      <div class="page-editor-split">
        <div class="page-editor-left">
          <nav class="section-nav">
            <button class="section-nav-btn active" onclick="showSection('about','hero','sk-section-hero',this)">Hero</button>
            <button class="section-nav-btn" onclick="showSection('about','smv','sk-section-smv',this)">Story / Mission / Vision</button>
            <button class="section-nav-btn" onclick="showSection('about','intro','sk-section-about-intro',this)">About Intro</button>
            <button class="section-nav-btn" onclick="showSection('about','principal','sk-section-principal',this)">Principal</button>
            <button class="section-nav-btn" onclick="showSection('about','people','sk-section-people',this)">Our People</button>
            <button class="section-nav-btn" onclick="showSection('about','teams','sk-section-teams',this)">Team Sections</button>
            <button class="section-nav-btn" onclick="showSection('about','parish','sk-section-parish',this)">Parish</button>
          </nav>
    ...
    <div id="tab-learning" class="tab-panel">
      <div class="page-editor-split">
        <div class="page-editor-left">
          <nav class="section-nav">
            <button class="section-nav-btn active" onclick="showSection('learning','hero','sk-section-hero',this)">Hero</button>
            <button class="section-nav-btn" onclick="showSection('learning','introquote','sk-section-intro-quote',this)">Intro Quote</button>
            <button class="section-nav-btn" onclick="showSection('learning','faith','sk-section-faith',this)">Faith &amp; Formation</button>
            <button class="section-nav-btn" onclick="showSection('learning','wellbeing','sk-section-wellbeing',this)">Belonging &amp; Wellbeing</button>
            <button class="section-nav-btn" onclick="showSection('learning','teaching','sk-section-teaching',this)">Teaching</button>
            <button class="section-nav-btn" onclick="showSection('learning','everychild','sk-section-every-child',this)">Every Child</button>
            <button class="section-nav-btn" onclick="showSection('learning','beyond','sk-section-beyond',this)">Beyond the Classroom</button>
          </nav>
      ...
      <?php
      $lrnSections = [
        0 => ['id'=>'faith',      'label'=>'Faith &amp; Formation',     'anchor'=>'sk-section-faith'],
        1 => ['id'=>'wellbeing',  'label'=>'Belonging &amp; Wellbeing', 'anchor'=>'sk-section-wellbeing'],
        2 => ['id'=>'teaching',   'label'=>'Teaching that Inspires',    'anchor'=>'sk-section-teaching'],
        3 => ['id'=>'everychild', 'label'=>'Learning for Every Child',  'anchor'=>'sk-section-every-child'],
        4 => ['id'=>'beyond',     'label'=>'Beyond the Classroom',      'anchor'=>'sk-section-beyond'],
      ];
      for ($i = 0; $i < 5; $i++):
    ...
    <div id="tab-community" class="tab-panel">
      <div class="page-editor-split">
        <div class="page-editor-left">
          <nav class="section-nav">
            <button class="section-nav-btn active" onclick="showSection('community','hero','sk-section-hero',this)">Hero</button>
            <button class="section-nav-btn" onclick="showSection('community','intro','sk-section-intro',this)">Intro</button>
            <button class="section-nav-btn" onclick="showSection('community','pillar1','sk-section-pillar-1',this)">Welcoming</button>
            <button class="section-nav-btn" onclick="showSection('community','pillar2','sk-section-pillar-2',this)">Families</button>
            <button class="section-nav-btn" onclick="showSection('community','pillar3','sk-section-pillar-3',this)">Celebrating</button>
            <button class="section-nav-btn" onclick="showSection('community','pillar4','sk-section-pillar-4',this)">Faith</button>
            <button class="section-nav-btn" onclick="showSection('community','spirit','sk-section-spirit',this)">Spirit</button>
          </nav>
    ...
    <div id="tab-enrolments" class="tab-panel">
      <div class="page-editor-split">
        <div class="page-editor-left">
          <nav class="section-nav">
            <button class="section-nav-btn active" onclick="showSection('enrolments','hero','sk-section-hero',this)">Hero</button>
            <button class="section-nav-btn" onclick="showSection('enrolments','intro','sk-section-intro',this)">Intro</button>
            <button class="section-nav-btn" onclick="showSection('enrolments','step1','sk-section-step1',this)">Step 1 — Visit</button>
            <button class="section-nav-btn" onclick="showSection('enrolments','step2','sk-section-step2',this)">Step 2 — Enquire</button>
            <button class="section-nav-btn" onclick="showSection('enrolments','step3','sk-section-step3',this)">Step 3 — Enrol</button>
            <button class="section-nav-btn" onclick="showSection('enrolments','transition','sk-section-transition',this)">Transition</button>
            <button class="section-nav-btn" onclick="showSection('enrolments','closingcta','sk-section-closing-cta',this)">Closing CTA</button>
            <button class="section-nav-btn" onclick="showSection('enrolments','tourdates','sk-section-step1',this)">Tour Dates</button>
          </nav>
    ...
    <div id="tab-contact" class="tab-panel">
      <div class="page-editor-split">
        <div class="page-editor-left">
          <nav class="section-nav">
            <button class="section-nav-btn active" onclick="showSection('contact','hero','sk-section-hero',this)">Hero</button>
            <button class="section-nav-btn" onclick="showSection('contact','intro','sk-section-intro',this)">Intro</button>
            <button class="section-nav-btn" onclick="showSection('contact','git','sk-section-contact-details',this)">Contact Details</button>
            <button class="section-nav-btn" onclick="showSection('contact','map','sk-section-contact-details',this)">Map Embed</button>
          </nav>
    ...
    <div id="tab-policies" class="tab-panel">
      <div class="page-editor-split">
        <div class="page-editor-left">
          <nav class="section-nav">
            <button class="section-nav-btn active" onclick="showSection('policies','hero','sk-section-hero',this)">Hero</button>
            <button class="section-nav-btn" onclick="showSection('policies','intro','sk-section-intro',this)">Policy Intro</button>
            <button class="section-nav-btn" onclick="showSection('policies','safesmart','sk-section-safesmart',this)">SafeSmart</button>
          </nav>
